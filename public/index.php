...
if($currentPath==='/webhooks/stripe' && is_post()) handle_stripe_webhook($store);
...
switch(true){
    ...
    case $currentPath==='/checkout/success':cart_clear();$pageTitle='Order received | '.$store['name'];$pageDescription='Your order has been received.';$template='/templates/success.php';break;
